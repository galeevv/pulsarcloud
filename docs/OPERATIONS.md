...
The 2 vCPU/4 GB target should run Pulsar alone. Co-locate Remnawave only after moving to at least 8 GB RAM and validating sustained memory/disk pressure; the safer topology is a separate Remnawave Panel VPS and separate traffic Nodes. See [REMNAWAVE.md](REMNAWAVE.md).
